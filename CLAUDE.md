...
- **Version `v0.4.1`** (tagged, pushed, released), on `main`, working tree clean. `main` is the only branch anyone should be working from right now — every feature branch below has already been merged in and none are currently active.
