...
**Tiến độ**: GĐ 0-7 đã xong local (commit `b4d21f31`, `eff18d13`, `f1ff1bd2`, `da111328`, `18a0eeca`, `a989d161`, `2f420118`, `5f496ad6` trên `feat/pokemon-battle-system`). **Push đang do người dùng tự làm thủ công** — máy này không có credential GitHub hoạt động (xem "Trạng thái git" bên dưới), đừng tự ý thử push nữa trừ khi được yêu cầu lại. Còn GĐ 8 (hoàn thiện: i18n cuối, clang-format, verification đầy đủ) — **đọc mục "GĐ 8" trong roadmap và bắt đầu từ đó**.
