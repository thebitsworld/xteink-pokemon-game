...
**Tiến độ**: **Toàn bộ 8 giai đoạn của roadmap chiến đấu đã xong**, cộng thêm **GĐ9-21 ngoài roadmap gốc** (commit `b4d21f31`, `eff18d13`, `f1ff1bd2`, `da111328`, `18a0eeca`, `a989d161`, `2f420118`, `5f496ad6`, `ddef31b0`, `62fd5028`, `194601a0`, `7605de43`, `060d272f`, `2fc7af7a`, `a554d92f`, `c3998aa9`, `22bb4638`, `5b9d24d2`, `19268f61`, `f2187062`, `ebb7e9fd`, `4d4f6bbb`, `950d72ce`, `9d433ad0`, `05b623ed`, `491411e7`, `0477355e`, `470120d1`, `9b12bae6`, `188b005d`, `719fd9e2`, `e1233cd8`, `e7c0968e`, `02fe4a15`, `6a014052`, `b808335d`, `d278b161`, `f0b49554`, `77c33495`, `fe283cb3`, `0cb2a666`, `db8e87c8`, `5ba48e7d`, `60625f11`, `9109663b`, `8b980ea0` trên `feat/pokemon-battle-system`). **Push đang do người dùng tự làm thủ công** — máy này không có credential GitHub hoạt động (xem "Trạng thái git" bên dưới), đừng tự ý thử push nữa trừ khi được yêu cầu lại.
...
- **GĐ21 (`8b980ea0`, ngoài kế hoạch, theo phản hồi khi phân tích tỉ lệ rớt Ball)**: người dùng hỏi vì sao khó có bóng để bắt Pokémon — mô phỏng cho thấy trung bình ~130 giờ đọc mới có 1 bóng, do `createItem()` roll phẳng trên 83 item khiến category nhiều loại nhất (Machine, 55 TM/HM) áp đảo xác suất (44%) dù mỗi TM/HM lẻ hiếm, còn Ball (chỉ 4 loại) chỉ ~9.8%. Sửa bằng roll 2 bước: chọn category trước theo trọng số cố định `CATEGORY_DROP_WEIGHTS` (Ball=25/Stone=10/Medicine=20/StatusCure=15/PPRestore=10/Machine=15/Candy=5, không phụ thuộc số lượng item trong category), rồi mới chọn item trong category đó theo `drop_weight` như cũ (nhánh ưu tiên đá tiến hóa cần thiết không đổi). Chỉ sửa `PokemonGame.cpp` + test. 20/20 test pass (thêm 1 test mới xác nhận ranh giới category). Ball giờ ước tính ~50-55h mới có lần đầu (thay vì ~130h) — có thể chỉnh thêm số trong `CATEGORY_DROP_WEIGHTS` nếu vẫn thấy chậm sau khi chơi thử.

Working tree sạch, mọi thứ đã commit, sẵn sàng để người dùng tự push. **Đã xác nhận bằng mắt GĐ19.5** (text wrap) — người dùng xác nhận "text wrap ok". GĐ20 (tool) đã hướng dẫn cách dùng. **Chưa xác nhận bằng mắt GĐ21** — cần chơi thử để cảm nhận tỉ lệ rớt Ball đã dễ chịu hơn chưa.
